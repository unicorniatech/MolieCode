...
export const appConcepts: Concept[] = [
  ...
  {
    id: "paquete-aprendizaje",
    name: "Paquete de aprendizaje",
    meaning: "Paquete de aprendizaje significa un archivo descargable que resume lo que construiste, aprendiste y decidiste durante un proyecto guiado.",
    purpose: "Sirve para guardar tu avance y revisar tus decisiones fuera de la app.",
    example: "Un archivo con tu idea, pantalla, formulario, registros de prueba y recomendaciones.",
  },
  {
    id: "exportar",
    name: "Exportar",
    meaning: "Exportar significa preparar información para descargarla o usarla fuera de la app.",
    purpose: "Sirve para conservar tu trabajo en un archivo local.",
    example: "Descargar tu paquete de aprendizaje en JSON o Markdown.",
  },
  {
    id: "json",
    name: "JSON",
    meaning: "JSON significa formato simple para guardar datos estructurados.",
    purpose: "Sirve para que una app pueda leer información con orden.",
    example: "Guardar puntos, campos y registros como datos organizados.",
  },
  {
    id: "markdown",
    name: "Markdown",
    meaning: "Markdown significa formato de texto fácil de leer que usa símbolos simples para títulos, listas y secciones.",
    purpose: "Sirve para crear resúmenes claros que una persona puede revisar rápido.",
    example: "Un archivo con títulos como Qué construiste y Recomendaciones siguientes.",
  },
  {
    id: "typescript",
    name: "TypeScript",
